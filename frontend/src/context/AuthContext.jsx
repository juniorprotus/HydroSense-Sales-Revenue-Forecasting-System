...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    const stored = localStorage.getItem('hydrosense_user')
  ...
  const login = async (username, password) => {
    ...
    localStorage.setItem('hydrosense_token', res.data.access_token)
    localStorage.setItem('hydrosense_user',  JSON.stringify(res.data.user))
